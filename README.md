...
| 成员 | 学号 | 工作量 | 主要工作 |
| :--- | :--- | :--- | :--- |
| 梁少天 | 20236533 | 70% | 总体架构、B1-B5 核心实现、Verification、Recovery、Web Console 与集成 |
| 刘广阔 | 20236507 | 10% | B2 Skill 工具函数模块 |
| 杨金鑫 | 20216424 | 10% | B3 工具说明生成与工具调用模块 |
| 王渲淏 | 20236512 | 10% | B5 记忆文档存储与查找模块 |
